...
% Helper to set the default value for a variable,
% if it wasn't set otherwise (e.g. via --raw-vars).
% Example: #(set-default! 'someVar 42)
#(define (set-default! sym val)
   (if (defined? sym)
       #f
       (eval `(define ,sym ,val) (current-module))))
